---
layout: post
title: "Shapelaysson = Shapeless + Play-Json "
date: 2013-02-27 00:00
comments: true
external-url: 
categories: [shapeless,play-json,scala,scala 2.10,play framework, json, polymorphic, hlist, heterogenous list, functional programming]
keywords: shapeless,play-json,scala,scala 2.10,play framework, json, polymorphic, hlist, heterogenous list, functional programming
---
...
> [Shapelaysson](https://github.com/mandubian/shapelaysson/) is a Github project with test/samples
